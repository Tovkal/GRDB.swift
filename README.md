...
**Latest release**: January 9, 2022 • [version 5.18.0](https://github.com/groue/GRDB.swift/tree/v5.18.0) • [CHANGELOG](CHANGELOG.md) • [Migrating From GRDB 4 to GRDB 5](Documentation/GRDB5MigrationGuide.md)
...
- [GRDB Reference](http://groue.github.io/GRDB.swift/docs/5.18/index.html) (generated by [Jazzy](https://github.com/realm/jazzy))
...
See [Configuration](http://groue.github.io/GRDB.swift/docs/5.18/Structs/Configuration.html) for more details.
...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/5.18/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
Values can be used as [statement arguments](http://groue.github.io/GRDB.swift/docs/5.18/Structs/StatementArguments.html):
...
Transactions can't be left opened unless you set the [allowsUnsafeTransactions](http://groue.github.io/GRDB.swift/docs/5.18/Structs/Configuration.html) configuration flag:
...
For more information about prepared statements, see the [Statement reference](http://groue.github.io/GRDB.swift/docs/5.18/Classes/Statement.html).
...
See [fetching methods](#fetching-methods) for information about the `fetchCursor`, `fetchAll`, `fetchSet` and `fetchOne` methods. See [StatementArguments](http://groue.github.io/GRDB.swift/docs/5.18/Structs/StatementArguments.html) for more information about the query arguments.
...
See [DatabaseColumnDecodingStrategy](https://groue.github.io/GRDB.swift/docs/5.18/Enums/DatabaseColumnDecodingStrategy.html) and [DatabaseColumnEncodingStrategy](https://groue.github.io/GRDB.swift/docs/5.18/Enums/DatabaseColumnEncodingStrategy.html) to learn about all available strategies.
...
See [DatabaseDateDecodingStrategy](https://groue.github.io/GRDB.swift/docs/5.18/Enums/DatabaseDateDecodingStrategy.html), [DatabaseDateEncodingStrategy](https://groue.github.io/GRDB.swift/docs/5.18/Enums/DatabaseDateEncodingStrategy.html), and [DatabaseUUIDEncodingStrategy](https://groue.github.io/GRDB.swift/docs/5.18/Enums/DatabaseUUIDEncodingStrategy.html) to learn about all available strategies.
...
Raw SQL snippets are also accepted, with eventual [arguments](http://groue.github.io/GRDB.swift/docs/5.18/Structs/StatementArguments.html):
...
- [AnyFetchRequest](http://groue.github.io/GRDB.swift/docs/5.18/Structs/AnyFetchRequest.html): a type-erased request.
...
For more details, see the [reference](https://groue.github.io/GRDB.swift/docs/5.18/Structs/DatabaseRegion.html).
...
For more information, see [Double-quoted String Literals Are Accepted](https://sqlite.org/quirks.html#dblquote), and [Configuration.acceptsDoubleQuotedStringLiterals](http://groue.github.io/GRDB.swift/docs/5.18/Structs/Configuration.html#/s:4GRDB13ConfigurationV33acceptsDoubleQuotedStringLiteralsSbvp).
...
This chapter was removed. See the references of [DatabaseReader](http://groue.github.io/GRDB.swift/docs/5.18/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/5.18/Protocols/DatabaseWriter.html).
...
[SQLRequest]: http://groue.github.io/GRDB.swift/docs/5.18/Structs/SQLRequest.html
